...
default_run = 'multinet2_me' # MultiNet_ICCV
...
def main(_):
    ...
    # king
    print ("---subhypes['segmentation']['jitter']: \n", subhypes['segmentation']['jitter'])
    ...
    hypes_seg = subhypes['segmentation']
    shape = image.shape
    print ("---shape: ", shape)
    image_height = hypes_seg['jitter']['image_height']
    image_width = hypes_seg['jitter']['image_width']
...
##### test
    ...
    # king 
    new_img = scp.misc.imresize(new_img, origin_shape)
